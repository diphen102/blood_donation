...
// GET /api/donations/mine (DONOR xem lịch sử hiến máu của chính mình)
...
// POST /api/donations
// Tạo Donation VÀ BloodUnit tương ứng trong 1 lần gọi.
// Nhóm máu VÀ loại chế phẩm của BloodUnit LUÔN lấy tự động từ Donor/Donation (không cho nhập tay lại)
// để tránh sai lệch giữa "toàn phần / tiểu cầu / huyết tương" khi tổng hợp tồn kho.
...
const createDonation = asyncHandler(async (req, res) => {
  ...
  const bloodUnit = await BloodUnit.create({
    ...
    donationType: type, // đồng bộ với Donation - dùng để tách tồn kho theo loại chế phẩm
    status: "COLLECTED",
